...
<link rel="icon" type="image/x-icon"
	href="resources/img/ico/Qmobile.ico" />
		...
		<div class="row">
			<div class="col-lg-2 col-md-3 col-sm-3 col-3 left-col">
				<a href="#"> <img class="img-fluid das-logo"
					src="${pageContext.request.contextPath}/resources/img/logos/logo.png">
				</a>
			...
			<div class="col-lg-10 col-md-9 col-sm-9 col-9 right-col">
				...
				<div>
					<img class="w-100"
						src="${pageContext.request.contextPath}/resources/img/banner/Picture1.jpg"
						alt="">
				</div>
